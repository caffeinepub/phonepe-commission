...
import type { FrontPhoto as _FrontPhoto } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addCommission(arg0: string, arg1: number, arg2: number, arg3: Time, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCommission(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addPhoto(arg0: bigint, arg1: FrontPhoto): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllCommissions(): Promise<Array<CommissionEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCommissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPhotos(): Promise<Array<FrontPhoto>> {
        if (this.processError) {
            try {
    ...
    async getPhoto(arg0: bigint): Promise<FrontPhoto | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FrontPhoto]): FrontPhoto | null {
